...
<head>
    ...
    <title>Change Staff | N/Kalaimagal MV</title>
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-10 mx-auto">
            <div class="flex flex-col text-center w-full mb-5">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-blue-600">Update Staffs
                </h1>
                <p class="text-sm md:text-base lg:w-2/3 mx-auto leading-relaxed text-base">
                    🎉 Welcome to this page dedicated to managing and updating staff! 📝 It
