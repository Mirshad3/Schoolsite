...
<head>
    ...
    <title>Registered Students | N/Kalaimagal MV</title>
        ...
        <div class="container px-5 py-10 mx-auto">
            <div class="flex flex-col text-center w-full mb-5">
                ...
                <p class="text-sm md:text-base lg:w-2/3 mx-auto leading-relaxed text-base">
                    Welcome to the New Registrations Section at Nelukkulam Kalaimagal Maha Vidyalayam! Admins can now easily track
