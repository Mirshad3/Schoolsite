        ...
        <section class="text-gray-600 body-font relative">
            <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap pt-0">
                <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    <iframe width="100%" height="100%" class="absolute inset-0" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15773.17564340774!2d80.45699809999999!3d8.758392985084734!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3afc157fa05a334d%3A0xa66a38a7a3da4196!2sVavuniya%20Nelukkulam%20Kalaimakal%20Maha%20Vidyalayam!5e0!3m2!1sen!2slk!4v1726550397488!5m2!1sen!2slk" style="filter: grayscale(0) contrast(1.2) opacity(0.7);"></iframe>
                     <div class="pr-2 bg-white relative flex flex-wrap py-6 rounded shadow-md">
                        <div class="lg:w-1/2 px-6">
                            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">ADDRESS</h2>
                            <p class="text-sm md:text-base text-justify mt-1 cursor-pointer" onclick="locationmap()"> Nelukkulam , Vavuniya</p>
                        </div>
                        <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                            <a class="text-sm md:text-base text-justify text-indigo-500 leading-relaxed cursor-pointer" onclick="mailschool()"> vnkmv2011@gmail.com</a>
                            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                            <p class="text-sm md:text-base text-justify leading-relaxed cursor-pointer" onclick="callschool()"> 0242224950</p>
                        </div>
                    </div>
                </div>
