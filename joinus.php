        ...
        <section class="max-w-4xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 mt-0 mb-10">
            ...
            <div style="display: none;" id="alert-additional-content-3"
                ...
                <div class="mt-2 mb-4 text-sm">
                    ...
                    Our N/Kalaimagal MV administrator will contact you soon for the admission process. Kindly visit our school
                ...
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select name="admit_to"
                            ...
                            <option>6 ( Tamil Medium) </option>
                            <option>7 ( English Medium )</option>
                            <option>7 ( Tamil Medium )</option>
                            <option>8 ( English Medium )</option>
                            <option>8 ( Tamil Medium )</option>
                            <option>9 ( Tamil Medium )</option>
                            <option>10 ( Tamil Medium )</option>
                            <option>11 ( Tamil Medium )</option>
                            <option>A/L( Science )</option>
                            <option>A/L( Commerce )</option>
                            <option>A/L( ITech )</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input placeholder="vnkmv2011@gmail.com" id="email" name="email" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
